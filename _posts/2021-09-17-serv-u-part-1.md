...
As it turns out, doing a git blame on line 294 shows us that the commit which introduced the use of OPENSSL_zalloc was in [2006](https://github.com/openssl/openssl/commit/b51bce942023325e727ca4225252d06c49d8f2b7). Unfortunately, Serv-U appears to use a version of libeay32.dll that was dated back to 2005. If only they had just used a more up-to-date libeay32, this vulnerability would probably be unexploitable.
